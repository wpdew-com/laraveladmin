...
return [
    ...
    */
    ...
    |
    | For detailed instructions you can look the user menu se1ction here:
    | https://github.com/jeroennoten/Laravel-AdminLTE/wiki/Basic-Configuration
    |
    */
    ...
    */
    ...
    'layout_fixed_footer' => ['md' => true, 'lg' => true, 'xl' => true],
    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    ...
                    'url'=> 'change-language/uk'
                ],
                [
                    'text'=>'Polski',
                    'icon' => 'flag-icon flag-icon-pl',
                    'url'=> 'change-language/pl'
                ],
                [
                    'text'=>'Русский',
                    'icon' => 'flag-icon flag-icon-ru',
                    'url'=> 'change-language/ru'
                ]
            ]
        ],
        [
        ...
        [
            ...
            //'can'       => ['superadmin', 'admin', 'editor', 'moderator'],
        ],
        ...
        [
            ...
            'icon'    => 'fas fa-fw fa-file',
            'url'  => '',
            //'can'       => ['superadmin', 'admin', 'moderator'],
            //'active' => ['advertisement/edit/*', 'advertisement/*', 'advertisement']
        ],
        ...
        [
           ...
           //'can'       => ['superadmin', 'admin', 'moderator'],
           // 'active' => ['adduser', 'users', 'profile*', 'regex:@^profile/[0-9]+$@']
        ],
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text' => 'general_settings_style_js',
                    'icon' => 'fas fa-fw fa-caret-right',
                    'url'  => '',
                ],
                [
...
/* 'can'       => ['superadmin', 'admin', 'editor', 'moderator', 'user'], */
        /*
        [
            'type'         => 'navbar-search',
            'text'         => 'search',
        ...
        'moment' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdn.jsdelivr.net/momentjs/latest/moment-with-locales.min.js',
                ]
            ],
        ],
        'daterangepicker' => [
